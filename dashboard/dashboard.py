...
st.header('Bike Sharing-Proyek Analisis Data')
...
st.subheader("Pada musim apa permintaan penyewaan sepeda mencapai puncak terendah? ")
...
st.subheader("Berapa perbandingan pelanggan yang memilih sewa registered dibandingkan dengan sewa casual?")
...
ax1.pie(sizes, explode=explode, labels=labels, autopct='%1.1f%%',colors=["#FF6347", "#87CEEB"],
